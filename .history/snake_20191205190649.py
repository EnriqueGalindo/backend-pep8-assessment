...
# Code courtesy of Sanchit
# Gangwar: https://gist.github.com/sanchitgangwar/2158089
...
while key != 27:
    ...
    snake.insert(0, [snake[0][0]\
         + (key == KEY_DOWN and 1) + (key == KEY_UP and -1), snake[0][1] + (key == KEY_LEFT and -1) + (key == KEY_RIGHT and 1)])
